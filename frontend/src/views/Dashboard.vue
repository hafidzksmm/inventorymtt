    ...
    async fetchCounts() {
      try {
        const [inventarisRes, inventaryRes, assetRes] = await Promise.all([
          axios.get("http://192.168.20.17:50/api/inventaris/inventaris"),
          axios.get("http://192.168.20.17:50/api/inventaryprojek/inventaryprojek"),
          axios.get("http://192.168.20.17:50/api/assetjual/assetjual"),
        ]);
