    ...
    async fetchCounts() {
      try {
        const [inventarisRes, inventaryRes, assetRes] = await Promise.all([
          axios.get("http://192.168.10.9:5000/api/inventaris/inventaris"),
          axios.get("http://192.168.10.9:5000/api/inventaryprojek/inventaryprojek"),
          axios.get("http://192.168.10.9:5000/api/assetjual/assetjual"),
        ]);
